...
const StudentTable = () => {
    ...
    const handleDelete=(id)=>{
        const newData=studentinfo.filter(li=>li.id!==id)
    ...
    return (
        ...
        <div className="row mt-5 studentlist">
            <div className="d-flex justify-content-between">
                ...
                <button type="button" className="btn btn-primary  text-center newbtn" data-bs-toggle="modal"
        ...
        <div className="row">
            <div className="d-flex justify-content-between">
                ...
                <div className="">
                    ...
                    <input type="text" onkeyup="searchTable()" id="txtFind" placeholder="ex:name"/>
            ...
            <div className="row mt-2 mb-4">
                <div className="d-flex justify-content-between">
                    ...
                    <div className="d-flex justify-content-space-between">
                        ...
                        <button id="back" className="me-1 btn btn-sm btn-info px-3" onclick="back()">Back</button>
                        <button id="pagenumber" className="fw-bold px-2 bg-light border border-1">1</button>
                        <button id="next" className="ms-1 btn btn-sm btn-info px-3" onclick="next()">Next</button>
                    </div>
                        ...
                        <div className="modal-body">
                            <form id="formone">
                                <div className="mb-3 input-icon">
                                    <label for="recipient-id" className="col-form-label">ID</label>
                                ...
                                <div className="mb-3 input-icon">
                                    <label for="recipient-course" className="col-form-label">Course Name</label>
